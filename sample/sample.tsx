...
export const Button: FC<ButtonProps> = (props) => {
  ...
  return (
    <>
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-2 sm:gap-x-8 sm:px-8 sm:py-12 md:py-16"
        transform="">
        <div class="relative z-10 col-start-1 row-start-1 bg-gradient-to-t from-black px-4 pt-40 pb-3 sm:bg-none">
          <p class="p-[calc(100%*2.5)] text-sm font-medium text-white sm:mb-1 sm:text-gray-500">
            Entire house
          </p>
        ...
        <div class="col-start-1 row-start-2 px-4 sm:pb-16">
          <div class="my-5 flex items-center text-sm font-medium sm:mt-2 sm:mb-4">
            <svg
              width="20"
              height="20"
              fill="currentColor"
            ...
            <div class="ml-1 hover:bg-sky-300 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed">
              <span class="text-xl text-black">4.94</span>
              <span class="sm:hidden md:inline">(128)</span>
            </div>
            <div class="mx-2 text-base font-normal">·</div>
          </div>
          <hr class="hidden w-16 border-gray-300 sm:block" />
        </div>
        <div class="col-start-1 row-start-3 space-y-3 px-4">
          <p class="flex items-center text-sm font-medium text-black">
            <img
              ...
              alt=""
              class="mr-2 h-6 w-6 rounded-full bg-gray-100"
            />
            Hosted by Kevin Francis
          </p>
          <button
            type="button"
            class="rounded-lg bg-violet-100 px-6 py-2 text-base font-semibold text-violet-700">
            Check availability
          </button>
        </div>
          ...
          <div class="grid w-full grid-cols-3 grid-rows-2 gap-2">
            <div class="relative col-span-3 row-span-2 md:col-span-2">
              <img
                src="/beach-house.jpg"
                alt=""
                class="absolute inset-0 h-full w-full bg-gray-100 object-cover sm:rounded-lg"
              />
            </div>
            <div class="relative hidden md:block">
              <img
                ...
                alt=""
                class="absolute inset-0 h-full w-full rounded-lg bg-gray-100 object-cover"
              />
            </div>
            <div class="relative hidden md:block">
              <img
